...
class DancerNotifSettingsScreen extends StatefulWidget {
  const DancerNotifSettingsScreen({
    super.key,
  });

  @override
  State<DancerNotifSettingsScreen> createState() =>
      _DancerNotifSettingsScreenState();
}

class _DancerNotifSettingsScreenState extends State<DancerNotifSettingsScreen> {
